...
//
// Declaring custom delegates for the Menu Class to bind delegates to
//
...
protected:
	...
	//
	// Internal Callback for the delegates that we will add to the Online Session Delegate List.
